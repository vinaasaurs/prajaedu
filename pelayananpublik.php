...
<head>
  ...
  <title>VidPemb & Forum Diskusi Pelayanan Publik</title>
...
<body>
  ...
  <div class="container mt-3">
    <div class="d-flex justify-content-between align-items-center">
      <div class="judul-materi">Pelayanan Publik</div>
    ...
    <div class="row mt-2">
      <div class="col-lg-8">
        <div class="bg-white p-3 rounded shadow-sm mb-3">
          <div class="fw-bold mb-2" style="font-size:1.2rem;">TES KARAKTERISTIK PRIBADI</div>
          <div class="row g-3">
            <div class="col-md-6">
              <video controls class="yt-thumb"
                ...
                <source src="videos/TKP 1.mp4" type="video/mp4">
                Browser Anda tidak mendukung tag video.
              </video>
              <div class="mt-2">
                <span class="fw-bold">Pelayanan Publik</span><br>
              ...
              <div class="mt-3">
                ...
                <div class="d-flex flex-column gap-2">
                  <a href="files/TKP 1.pdf" class="btn btn-outline-primary btn-sm" download>
                    <i class="fas fa-file-pdf me-2"></i>Download Materi Pelayanan Publik
                  </a>
                </div>
              </div>
            </div>
        ...
        <div class="desc-box">
          ...
          <div>Pemahaman Bacaan adalah kemampuan memahami informasi, inti, serta makna yang terkandung
            ...
            <br><br>
            Materi Pemahaman Bacaan dalam TKP mencakup:
            <ul>
