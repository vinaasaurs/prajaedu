...
try {
    ...
    if ($table_exists && $table_exists->num_rows > 0) {
        ...
        if ($column_exists && $column_exists->num_rows > 0) {
            $sql = "SELECT * FROM forum_diskusi WHERE materi = 'Pancasila' ORDER BY tanggal DESC";
...
<body>
  ...
  <div class="container mt-3">
    <div class="d-flex justify-content-between align-items-center">
      <div class="judul-materi">Pancasila</div>
      ...
      <div class="col-lg-8">
        <div class="bg-white p-3 rounded shadow-sm mb-3">
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <video controls class="yt-thumb" style="width: 100%; max-width: 480px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.07); margin-bottom: 12px;">
                <source src="videos/TWK 1.mp4" type="video/mp4">
                Browser Anda tidak mendukung tag video.
              </video>
                <div class="mt-2">
                  <span class="fw-bold">PANCASILA</span><br>
                ...
                <div class="mt-3">
                  ...
                  <div class="d-flex flex-column gap-2">
                    <a href="files/TWK 1.pdf" class="btn btn-outline-primary btn-sm" download>
                      <i class="fas fa-file-pdf me-2"></i>Download Materi TWK 1
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div class="desc-box">
            ...
            <div>Pancasila adalah dasar negara dan ideologi bangsa Indonesia yang menjadi pedoman dalam kehidupan
              bermasyarakat, berbangsa, dan bernegara. Dalam materi Tes Wawasan Kebangsaan (TWK) pada Seleksi Kompetensi
              Dasar (SKD), Pancasila menjadi salah satu topik penting yang sering diujikan karena berkaitan langsung
              dengan pemahaman dasar negara Indonesia.<br><br>
              Materi Pancasila dalam TWK mencakup:
              <ul>
                <li>Pengertian dan makna Pancasila</li>
                <li>Sejarah perumusan dan tokoh perumus Pancasila</li>
                <li>Fungsi dan kedudukan Pancasila sebagai dasar negara</li>
                <li>Nilai-nilai yang terkandung dalam setiap sila</li>
                <li>Implementasi Pancasila dalam kehidupan sehari-hari</li>
              </ul>
            </div>
          </div>
        </div>
