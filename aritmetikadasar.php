...
<head>
  ...
  <title>VidPemb & Forum Diskusi Aritmetika Dasar</title>
...
<body>
  ...
  <div class="container mt-3">
    <div class="d-flex justify-content-between align-items-center">
      <div class="judul-materi">Aritmetika Dasar</div>
    ...
    <div class="row mt-2">
      <div class="col-lg-8">
        <div class="bg-white p-3 rounded shadow-sm mb-3">
          <div class="fw-bold mb-2" style="font-size:1.2rem;">TES INTELEGENSI UMUM</div>
          <div class="row g-3">
            <div class="col-md-6">
              <video controls class="yt-thumb" style="width: 100%; max-width: 480px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.07); margin-bottom: 12px;">
                <source src="videos/TIU 3.mp4" type="video/mp4">
                Browser Anda tidak mendukung tag video.
              </video>
                <div class="mt-2">
                  <span class="fw-bold">Aritmetika Dasar</span><br>
                ...
                <div class="mt-3">
                  ...
                  <div class="d-flex flex-column gap-2">
                    <a href="files/TIU 3.pdf" class="btn btn-outline-primary btn-sm" download>
                      <i class="fas fa-file-pdf me-2"></i>Download Materi Aritmetika Dasar
                    </a>
                  </div>
                </div>
              </div>
        ...
        <div class="desc-box">
          ...
          <div>Aritmetika Dasar adalah materi yang mencakup perhitungan matematika 
            dasar yang sering digunakan dalam kehidupan sehari-hari, seperti operasi hitung penjumlahan, 
            pengurangan, perkalian, pembagian, persen, pecahan, dan perbandingan. Dalam Tes Wawasan 
            Kebangsaan (TWK) pada Seleksi Kompetensi Dasar (SKD), pemahaman tentang aritmetika dasar penting 
            untuk membantu peserta dalam menjawab soal-soal yang memerlukan kemampuan berhitung cepat dan akurat, khususnya yang berkaitan dengan data, angka, dan informasi numerik.
          <br><br>
            Materi Aritmetika Dasar dalam TWK mencakup:
            <ul>
            <li>Operasi hitung dasar (penjumlahan, pengurangan, perkalian, pembagian)</li>
            <li>Pecahan, desimal, persen, dan konversinya</li>
            <li>Perbandingan, rasio, dan proporsi</li>
          </ul>
          </div>
        </div>
      </div>
