    ...
    if ($table_exists && $table_exists->num_rows > 0) {
        ...
        if ($column_exists && $column_exists->num_rows > 0) {
            ...
            if ($stmt->execute()) {
                ...
                header("Location: teknologiinformasi.php");
                exit();
            } else {
...
try {
    ...
    if ($table_exists && $table_exists->num_rows > 0) {
        ...
        if ($column_exists && $column_exists->num_rows > 0) {
            $sql = "SELECT * FROM forum_diskusi WHERE materi = 'Teknologi Informasi' ORDER BY tanggal DESC";
...
<head>
    ...
    <title>VidPemb & Forum Diskusi Teknologi Informasi</title>
...
<body>
    ...
    <div class="container mt-3">
        <div class="d-flex justify-content-between align-items-center">
            <div class="judul-materi">Teknologi Informasi</div>
        ...
        <div class="row mt-2">
            <div class="col-lg-8">
                <div class="bg-white p-3 rounded shadow-sm mb-3">
                    <div class="fw-bold mb-2" style="font-size:1.2rem;">TEKNOLOGI INFORMASI</div>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <video controls class="yt-thumb"
                                ...
                                <source src="videos/TKP4.mp4" type="video/mp4">
                                Browser Anda tidak mendukung tag video.
                            </video>
                            <div class="mt-2">
                                <span class="fw-bold">Teknologi Informasi</span><br>
                                <span style="color:#252D79; font-size:1.05rem;">Materi, contoh soal dan pembahasan
                                    sesuai FR CPNS 2023 &
                            ...
                            <div class="mt-3">
                                ...
                                <div class="d-flex flex-column gap-2">
                                    <a href="files/TKP 4.pdf" class="btn btn-outline-primary btn-sm" download>
                                        <i class="fas fa-file-pdf me-2"></i>Download Materi Teknologi Informasi
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="desc-box">
                    ...
                    <div>Teknologi Informasi adalah kemampuan memahami dan menguasai teknologi informasi yang digunakan dalam kehidupan sehari-hari dan dunia kerja. Dalam Tes Karakteristik Pribadi (TKP) pada Seleksi Kompetensi Dasar (SKD), materi teknologi informasi mencakup pemahaman tentang komputer, internet, aplikasi office, dan teknologi terkini.
                        <br><br>
                        Materi Teknologi Informasi dalam TKP mencakup:
                        <ul>
                            <li>Pengenalan teknologi informasi dan komunikasi</li>
                            <li>Penggunaan aplikasi office (Word, Excel, PowerPoint)</li>
                            <li>Internet dan aplikasi web</li>
                            <li>Keamanan informasi dan privasi digital</li>
                            <li>Teknologi terkini dan dampaknya</li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="forum-box">
                            ...
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <div class="komentar-item">
                                    <div class="komentar-header">
                                        ...
                                        <span
                                            class="komentar-tanggal"><?php echo date('d/m/Y H:i', strtotime($row['tanggal'])); ?></span>
                                    </div>
                    ...
                    <div class="forum-footer">
                        <form method="post" action="" class="d-flex align-items-center">
                            <input type="text" name="komentar" class="forum-input" placeholder="Masukkan Komentar"
                                required>
