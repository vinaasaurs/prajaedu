...
<head>
  ...
  <title>VidPemb & Forum Diskusi Sistem Pemerintahan Indonesia</title>
...
<body>
  ...
  <div class="container mt-3">
    <div class="d-flex justify-content-between align-items-center">
      <div class="judul-materi">Sistem Pemerintahan Indonesia</div>
    ...
    <div class="row mt-2">
      <div class="col-lg-8">
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <video controls class="yt-thumb"
                ...
                <source src="videos/TWK 3.mp4" type="video/mp4">
                Browser Anda tidak mendukung tag video.
              </video>

              <div class="mt-2">
                <span class="fw-bold">Sistem Pemerintahan Indonesia</span><br>
              ...
              <div class="mt-3">
                ...
                <div class="d-flex flex-column gap-2">
                  <a href="files/TWK 3.pdf" class="btn btn-outline-primary btn-sm" download>
                    <i class="fas fa-file-pdf me-2"></i>Download Materi Sistem Pemerintahan Indonesia
                  </a>
                </div>
              </div>
        ...
        <div class="desc-box">
          ...
          <div>Sistem Pemerintahan Indonesia adalah tata cara penyelenggaraan pemerintahan negara yang diatur dalam UUD
            1945 sebagai konstitusi negara Indonesia. Sistem ini menjadi pedoman dalam pelaksanaan kekuasaan negara agar
            terwujud penyelenggaraan pemerintahan yang adil, transparan, dan bertanggung jawab. Dalam Tes Wawasan
            Kebangsaan (TWK) pada Seleksi Kompetensi Dasar (SKD), pemahaman tentang sistem pemerintahan menjadi salah
            satu topik penting karena berkaitan dengan pembagian kekuasaan, tugas dan wewenang lembaga negara, serta
            peran rakyat dalam sistem demokrasi Pancasila.
            <ul>
              <p>Pengertian dan makna Pancasila : </p>
              <li>Pengertian sistem pemerintahan dan dasar hukumnya dalam UUD 1945</li>
              <li>Bentuk negara, bentuk pemerintahan, dan sistem pemerintahan Indonesia (Negara Kesatuan, Republik,
                Demokrasi Pancasila, Presidensial)</li>
            </ul>
          </div>
        </div>
      </div>
