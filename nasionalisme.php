  ...
  if ($table_exists && $table_exists->num_rows > 0) {
    ...
    if ($column_exists && $column_exists->num_rows > 0) {
      ...
      if ($stmt->execute()) {
        ...
        header("Location: nasionalisme.php");
        exit();
      } else {
...
try {
  ...
  if ($table_exists && $table_exists->num_rows > 0) {
    ...
    if ($column_exists && $column_exists->num_rows > 0) {
      $sql = "SELECT * FROM forum_diskusi WHERE materi = 'Nasionalisme' ORDER BY tanggal DESC";
...
<head>
  ...
  <title>VidPemb & Forum Diskusi Nasionalisme</title>
...
<body>
  ...
  <div class="container mt-3">
    <div class="d-flex justify-content-between align-items-center">
      <div class="judul-materi">Nasionalisme</div>
    ...
    <div class="row mt-2">
      <div class="col-lg-8">
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <video controls class="yt-thumb"
                ...
                <source src="videos/TWK 4.mp4" type="video/mp4">
                Browser Anda tidak mendukung tag video.
              </video>
              <div class="mt-2">
                <span class="fw-bold">Nasionalisme</span><br>
              ...
              <div class="mt-3">
                ...
                <div class="d-flex flex-column gap-2">
                  <a href="files/TWK 4.pdf" class="btn btn-outline-primary btn-sm" download>
                    <i class="fas fa-file-pdf me-2"></i>Download Materi Nasionalisme
                  </a>
                </div>
              </div>
            </div>
        ...
        <div class="desc-box">
          ...
          <div>Nasionalisme dan Bela Negara adalah sikap dan tindakan yang mencerminkan cinta terhadap tanah air dan
            kesadaran untuk mempertahankan kedaulatan negara dari segala bentuk ancaman, baik dari dalam maupun luar
            negeri. Dalam Tes Wawasan Kebangsaan (TWK) pada Seleksi Kompetensi Dasar (SKD), materi ini menjadi salah
            satu topik penting karena berkaitan erat dengan semangat persatuan dan peran setiap warga negara dalam
            menjaga keutuhan Negara Kesatuan Republik Indonesia (NKRI).
            <br><br>
            Materi Nasionalisme dan Bela Negara dalam TWK mencakup:
            <ul>
              <li>Pengertian nasionalisme dan pentingnya bagi persatuan bangsa</li>
              <li>Dasar hukum bela negara, termasuk UUD 1945 Pasal 27 Ayat 3 dan Pasal 30 Ayat 1</li>
              <li>Wujud bela negara dalam kehidupan sehari-hari seperti mematuhi hukum, menjaga persatuan, dan ikut
                berkontribusi bagi kemajuan bangsa</li>
              <li>Peran pemuda dalam bela negara</li>
              <li>Contoh sikap nasionalisme dalam era global</li>
            </ul>
          </div>
        </div>
      </div>
