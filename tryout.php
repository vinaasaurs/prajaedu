    ...
    <div class="row">
      ...
      <div class="main-content">
        <div class="paketku-header-bar">
          <div class="paketku-header-title">TryOut</div>
        ...
        <div class="content-box">
          ...
          <br>
          <div style="display:flex; gap:12px; width:100%;"></div>
          <div class="tryout-box">
            <span>TryOut SKD1</span>
            <button class="tryout-btn" onclick="window.location.href='https://docs.google.com/forms/d/e/1FAIpQLSdkh2ubTQqR5Uq9lK48KJ0D1iR-I8WW7N9FvGsFdKsr4IL51w/viewform'"> MASUK </button>
          </div>
          <div class="tryout-box">
            <span>TryOut SKD2</span>
            <button class="tryout-btn" onclick="window.location.href='https://docs.google.com/forms/d/e/1FAIpQLSdkh2ubTQqR5Uq9lK48KJ0D1iR-I8WW7N9FvGsFdKsr4IL51w/viewform'"> MASUK </button>
          </div>
        </div>
      </div>
