...
<head>
  ...
  <title>VidPemb & Forum Diskusi Deret Angka</title>
...
<body>
  ...
  <div class="container mt-3">
    <div class="d-flex justify-content-between align-items-center">
      <div class="judul-materi">Deret Angka</div>
    ...
    <div class="row mt-2">
      <div class="col-lg-8">
        <div class="bg-white p-3 rounded shadow-sm mb-3">
          <div class="fw-bold mb-2" style="font-size:1.2rem;">Deret Angka</div>
          <div class="row g-3">
            <div class="col-md-6">
              <video controls class="yt-thumb"
                ...
                <source src="videos/TIU 1.mp4" type="video/mp4">
                Browser Anda tidak mendukung tag video.
              </video>
              <div class="mt-2">
                <span class="fw-bold">Deret Angka</span><br>
              ...
              <div class="mt-3">
                ...
                <div class="d-flex flex-column gap-2">
                  <a href="files/TIU 1.pdf" class="btn btn-outline-primary btn-sm" download>
                    <i class="fas fa-file-pdf me-2"></i>Download Materi Deret Angka
                  </a>
                </div>
              </div>
            </div>
        ...
        <div class="desc-box">
          ...
          <div>Deret Angka dan Huruf adalah materi yang menguji kemampuan peserta
            dalam mengenali pola atau urutan angka dan huruf secara logis dan sistematis.
            Dalam Tes Wawasan Kebangsaan (TWK) pada Seleksi Kompetensi Dasar (SKD), soal
            tentang deret angka dan huruf bertujuan untuk melatih kemampuan berpikir kritis,
            analitis,dan teliti dalam menemukan pola, hubungan, serta menyimpulkan jawaban yang tepat.
            <br><br>
            Materi Deret Angka dan Huruf dalam TWK mencakup:
            <ul>
              <li>Pola dasar pada deret angka (penjumlahan, pengurangan, perkalian, pembagian, bilangan ganjil-genap,
                bilangan prima)</li>
              <li>Pola dasar pada deret huruf (urutan abjad, lompat huruf, huruf maju-mundur)</li>
              <li>Pola kombinasi angka dan huruf</li>
              <li>Teknik menemukan pola pada soal deret</li>
            </ul>
          </div>
        </div>
      </div>
