...
<head>
  ...
  <title>VidPemb & Forum Diskusi Jejaring Kerja</title>
...
<body>
  ...
  <div class="container mt-3">
    <div class="d-flex justify-content-between align-items-center">
      <div class="judul-materi">Jejaring Kerja</div>
          ...
          <div class="row g-3">
            <div class="col-md-6">
              <video controls class="yt-thumb"
                ...
                <source src="videos/TKP 2.mp4" type="video/mp4">
                Browser Anda tidak mendukung tag video.
              </video>
              <div class="mt-2">
                <span class="fw-bold">Jejaring Kerja</span><br>
              ...
              <div class="mt-3">
                ...
                <div class="d-flex flex-column gap-2">
                  <a href="files/TKP 2.pdf" class="btn btn-outline-primary btn-sm" download>
                    <i class="fas fa-file-pdf me-2"></i>Download Materi Jejaring Kerja
                  </a>
                </div>
              </div>
            </div>
