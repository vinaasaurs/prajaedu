    ...
    <div class="row mt-2">
      <div class="col-lg-8">
        <div class="bg-white p-3 rounded shadow-sm mb-3"> 
          <div class="row g-3">
            <div class="col-md-6">
              <img src="img/content/tkp1.jpg" class="yt-thumb" alt="Pancasila Video Thumbnail">
        ...
        <div class="desc-box">
          ...
          <div>Integritas Diri adalah sikap jujur, bertanggung jawab, dan berkomitmen untuk menjalankan nilai-nilai kebenaran, 
            etika, dan moral dalam kehidupan sehari-hari. Dalam Tes Wawasan Kebangsaan (TWK) pada Seleksi Kompetensi Dasar (SKD), 
            materi ini menjadi penting karena mencerminkan karakter calon aparatur sipil negara (ASN) yang berakhlak mulia, menjunjung tinggi nilai-nilai 
            kejujuran, dan dapat dipercaya dalam menjalankan tugas negara.
          <br><br>
            Materi Integritas Diri dalam TWK mencakup:
            <ul>
            <li>Pengertian integritas dan ciri-ciri pribadi berintegritas</li>
            <li>Pentingnya integritas dalam kehidupan pribadi, bermasyarakat, dan sebagai ASN</li>
            <li>Contoh perilaku yang mencerminkan integritas, seperti berkata jujur, menepati janji, dan bertanggung jawab</li>
            <li>Dampak positif integritas bagi individu, organisasi, dan bangsa</li>
          </ul>
          </div>
        </div>
      </div>
