...
<body>
  ...
  <div class="container mt-3">
    <div class="judul-materi">Logika dan Penalaran</div>
    <div class="row mt-2">
      <div class="col-lg-8">
        <div class="bg-white p-3 rounded shadow-sm mb-3"> 
          <div class="row g-3">
            <div class="col-md-6">
              <img src="img/content/tiu1.jpg" class="yt-thumb" alt="Pancasila Video Thumbnail">
        ...
        <div class="desc-box">
          ...
          <div>Logika dan Penalaran adalah kemampuan berpikir secara rasional, sistematis, dan terstruktur untuk menarik kesimpulan yang tepat dari informasi yang tersedia. Dalam Tes Wawasan Kebangsaan (TWK) pada Seleksi Kompetensi Dasar (SKD), materi ini menjadi penting karena membantu peserta dalam memahami konsep berpikir kritis, analitis, dan logis dalam menghadapi berbagai persoalan kebangsaan, hukum, dan kehidupan sehari-hari.
          <br><br>
            Materi Logika dan Penalaran dalam TWK mecakup :
            <ul>
            <li>Pengertian logika dan penalaran</li>
            <li>Jenis-jenis penalaran: induktif, deduktif, dan analogi</li>
            <li>Hubungan antar pernyataan (premis dan kesimpulan)</li>
            <li>Prinsip dasar berpikir logis (benar-salah, sebab-akibat, hubungan pernyataan)</li>
