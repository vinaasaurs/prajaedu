    ...
    <div class="row">
      ...
      <div class="main-content">
        <div class="paketku-header-bar">
          <div class="paketku-header-title">File</div>
        ...
        <div class="content-box">
          ...
          <div class="tab-menu">
            ...
            <a href="file.php" class="tab-link active"><i class="fa fa-file"></i> File</a>
          </div>
          <br>
          <div style="text-align:center; margin-bottom:18px; font-weight:500;">Tidak Ada Data Ditemukan</div>
          </br>
        </div>
      </div>
