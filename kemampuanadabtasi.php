...
<body>
  ...
  <div class="container mt-3">
    <div class="judul-materi">kemampuan Beradaptasi</div>
    <div class="row mt-2">
      <div class="col-lg-8">
        <div class="bg-white p-3 rounded shadow-sm mb-3"> 
          <div class="row g-3">
            <div class="col-md-6">
              <img src="img/content/tkp3.jpg" class="yt-thumb" alt="Pancasila Video Thumbnail">
        ...
        <div class="desc-box">
          ...
          <div>Kemampuan Beradaptasi adalah keterampilan untuk menyesuaikan diri dengan berbagai perubahan,
            tantangan, dan situasi baru dengan cepat dan tepat. Dalam Tes Wawasan Kebangsaan (TWK) pada Seleksi
            Kompetensi Dasar (SKD), kemampuan ini penting karena calon ASN harus siap menghadapi dinamika pekerjaan,
            perkembangan teknologi, dan perubahan sosial yang terjadi di lingkungan kerja dan masyarakat.
          <br><br>
            Materi Kemampuan Beradaptasi dalam TWK mencakup:
            <ul>
            <li>Pengertian kemampuan beradaptasi dan pentingnya dalam kehidupan sehari-hari</li>
            <li>Ciri-ciri individu yang adaptif, seperti fleksibel, terbuka terhadap perubahan, dan mampu belajar hal baru</li>
            <li>Contoh situasi yang membutuhkan kemampuan beradaptasi</li>
            <li>Strategi untuk meningkatkan kemampuan beradaptasi, seperti meningkatkan keterampilan, belajar teknologi baru</li>
          </ul>
          </div>
        </div>
      </div>
